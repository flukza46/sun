                    ...
                    <div class="row">
                      ...
                      <?php
                        ...
                        ?>
                            ...
                            <b class="text-success">ราคาทั้งหมด : </b><input id="equip-total" type="number" disabled="true" class="text-right ml-2 font-weight-bold text-danger bg-dark" value="0"> <b class="text-success ml-2">บาท</b>
                            </div>
                    </div> 
                    </div>
