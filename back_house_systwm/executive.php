...
font-family: 'Trirong', serif;">
        <nav class="sb-topnav navbar navbar-expand navbar-light bg-warning">
            <a class="navbar-brand"><i class="fas fa-user-circle"></i> ผู้บริหาร</font></a>
            ...
            <div id="layoutSidenav_nav">
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion" >
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            <a class="nav-link collapsed" href="executive.php?p=1"  data-target="#collapseLayouts" aria-expanded="false" aria-controls="collapseLayouts">
